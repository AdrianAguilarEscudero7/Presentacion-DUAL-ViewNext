	...
	<section>
		<div class="section-main">
			<div class="sub-section">
				...
				<c:set var="responsable" value="${estadisticas.getResponsable()}"/>
					<select id="index-select" name="respSelected">
						...
						<%
							...
							while (rs.next()) {
								...
								out.println("<option class='optionSelected'>"+auxResp+"</option>");	
							}
							
							conex.close(); // Conexión cerrada
						%>
					</select>
						<input style="display: none;" id="btn-submit-select-respCarga" type="submit">
				</form>
				<script>
